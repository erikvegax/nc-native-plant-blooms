    ...
    >
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden">
        ...
        <div className="px-6 py-5 space-y-5 text-sm text-stone-600">
          ...
          <div>
            <h3 className="font-semibold text-stone-700 mb-2 uppercase text-xs tracking-wide">Find Native Plants</h3>
            <p className="mb-2 text-stone-500 text-xs">Looking to purchase the plants in your plan? The NC Wildflower Society maintains a directory of nurseries across the state that carry NC native plants.</p>
            <a
              href="https://ncwildflower.org/native-plant-nurseries/"
              target="_blank"
              rel="noreferrer"
            ...
            >
              NC Native Plant Nursery Directory
